(function () {
  ...
  st.textContent = [
    ...
    '.cw-msg--mgr .cw-msg-bubble::after{content:"";position:absolute;inset:0;border-radius:inherit;border:2.25px solid rgba(255,255,255,.82);-webkit-mask-image:linear-gradient(to bottom,black 0px,black 8px,transparent 16px),linear-gradient(to right,black 0%,black 78%,transparent 93%);-webkit-mask-composite:source-in;mask-image:linear-gradient(to bottom,black 0px,black 8px,transparent 16px),linear-gradient(to right,black 0%,black 78%,transparent 93%);mask-composite:intersect;pointer-events:none;}',
    '.cw-msg--mgr .cw-msg-bubble::before{content:"";position:absolute;inset:0;border-radius:inherit;border:2.25px solid rgba(255,255,255,.82);-webkit-mask-image:linear-gradient(to right,black 0px,black 8px,transparent 16px),linear-gradient(to bottom,black 0%,black 22%,transparent 40%);-webkit-mask-composite:source-in;mask-image:linear-gradient(to right,black 0px,black 8px,transparent 16px),linear-gradient(to bottom,black 0%,black 22%,transparent 40%);mask-composite:intersect;pointer-events:none;}',
    ...
    '.cw-typing-bubble::after{content:"";position:absolute;inset:0;border-radius:inherit;border:2.25px solid rgba(255,255,255,.82);-webkit-mask-image:linear-gradient(to bottom,black 0px,black 8px,transparent 16px),linear-gradient(to right,black 0%,black 78%,transparent 93%);-webkit-mask-composite:source-in;mask-image:linear-gradient(to bottom,black 0px,black 8px,transparent 16px),linear-gradient(to right,black 0%,black 78%,transparent 93%);mask-composite:intersect;pointer-events:none;}',
    '.cw-typing-bubble::before{content:"";position:absolute;inset:0;border-radius:inherit;border:2.25px solid rgba(255,255,255,.82);-webkit-mask-image:linear-gradient(to right,black 0px,black 8px,transparent 16px),linear-gradient(to bottom,black 0%,black 22%,transparent 40%);-webkit-mask-composite:source-in;mask-image:linear-gradient(to right,black 0px,black 8px,transparent 16px),linear-gradient(to bottom,black 0%,black 22%,transparent 40%);mask-composite:intersect;pointer-events:none;}',
